    ...
    return (
        <div className="flex h-screen bg-gray-800 text-white">
            ...
            <main className="flex-1 overflow-y-auto flex flex-col">
                ...
                >
                    {/* Sticky Header */}
                    <header className="sticky top-0 z-30 flex justify-end items-center px-4 md:px-10 py-4 md:py-6 bg-gray-800/90 backdrop-blur border-b border-gray-700">
                    ...
                    {/* Main Content */}
                    <div className="flex-1 p-6 md:p-10 h-full  transition-all duration-300">
