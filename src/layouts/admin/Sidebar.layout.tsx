...
const SidebarLayout: React.FC = () => {
  ...
  const user = useUserInfo();
    ...
    return (
        <div className="w-[350px] bg-gray-800 text-white h-screen p-10">
            <div className="p-4">
                <Link to={ROUTER_URL.COMMON.HOME} className="flex justify-start items-center">
                    {/*<h1 className="text-3xl font-bold text-amber-400">ADMIN</h1>*/}
                    <img src={logo} alt="Logo" className="w-28 object-cover mb-2"/>
                </Link>
                {user && (
                    <div className="mt-4 flex items-center space-x-3">
                        {user.avatarUrl ? (
                            ...
                            <div
                                className="w-10 h-10 rounded-full bg-amber-400 flex items-center justify-center text-gray-900 font-bold">
