        ...
        {isOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <motion.div
              ...
              className="bg-gray-800 rounded-lg p-8 w-full max-w-lg"
            >
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-8 text-base leading-relaxed">
                  Bạn có chắc chắn muốn xóa tin tức này? <br />
                ...
                <div className="flex justify-center space-x-4">
                  <button
                    ...
                    disabled={isDeleting}
                    className="px-6 py-3 border border-gray-600 text-gray-300 rounded-lg hover:bg-gray-700 disabled:opacity-50 min-w-[100px]"
                  >
                    Hủy
                  </button>
                  <button
                    ...
                    disabled={isDeleting}
                    className="px-6 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed min-w-[100px]"
                  >
